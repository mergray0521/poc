...
with col1:
    ...
    col1.button("Purchase My Say", key="purchase_my_say", help="my-button")
    col1.image(token_4, caption="Minion Glasses", use_column_width=True, width=300)
    col1.text("2,000 points")
    col1.button("Purchase Glasses", key="purchase_glasses", help="my-button")
...
with col2:
    ...
    col2.button("Purchase My Way", key="purchase_my_way", help="my-button")
    col2.image(token_5, caption="Park Pass", use_column_width=True, width=50)
    col2.text("4,000 points")
    col2.button("Purchase Pass", key="purchase_pass", help="my-button")
    st.markdown('</div>', unsafe_allow_html=True)
...
with col3:
    ...
    col3.button("Purchase My Day", key="purchase_my_day", help="my-button")
