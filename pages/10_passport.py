...
html_code_row3_left = """
    ...
    <img src= "https://github.com/mergray0521/poc/blob/main/images/ticket.png?raw=true">
    </div>
"""
html_code_row3_right = """
    <div class="custom-box">
    <h3 class="custom-header">Hotel Keys</h3>
    <img src= "https://github.com/mergray0521/poc/blob/main/images/key.png?raw=true">
    </div>
"""
